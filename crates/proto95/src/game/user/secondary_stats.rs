...
pub struct TwoStateBase {
    pub value: u32,
    pub reason: u32,
    pub last_updated: ShroomDurationMs16,
}
...
pub struct TwoStateExpireCurrentTime {
    pub base: TwoStateBase,
    pub current_time: ShroomTimeOffset,
    pub expire_term: ExpireTerm,
}
    ...
    fn is_movement_affecting(&self) -> bool {
        self.contains(
            CharSecondaryStatFlags::Speed
                | CharSecondaryStatFlags::Jump
                | CharSecondaryStatFlags::Stun
                | CharSecondaryStatFlags::Weakness
                | CharSecondaryStatFlags::Slow
                | CharSecondaryStatFlags::Morph
                | CharSecondaryStatFlags::Ghost
                | CharSecondaryStatFlags::BasicStatUp
                | CharSecondaryStatFlags::Attract
                | CharSecondaryStatFlags::RideVehicle
                | CharSecondaryStatFlags::Flying
                | CharSecondaryStatFlags::Frozen
                | CharSecondaryStatFlags::DashSpeed
                | CharSecondaryStatFlags::DashJump
                | CharSecondaryStatFlags::PartyBooster
                | CharSecondaryStatFlags::YellowAura,
        )
    }
    ...
    fn has_swallow_stats(&self) -> bool {
        self.contains(
            CharSecondaryStatFlags::SwallowAttackDamage
                | CharSecondaryStatFlags::SwallowCritical
                | CharSecondaryStatFlags::SwallowMaxMP
                | CharSecondaryStatFlags::SwallowDefence
                | CharSecondaryStatFlags::SwallowEvasion,
        )
    }
